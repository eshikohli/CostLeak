  ...
  recommendations: [
    {
      ...
      recommendedFix: "Add a debounce of 300–500ms so the API is only called after the user pauses, not on every single event. In JavaScript: use setTimeout/clearTimeout or a library like lodash.debounce.",
      expectedImpact: "Reduces API calls by 80–95% for typing-triggered requests, cutting costs proportionally.",
    },
    {
