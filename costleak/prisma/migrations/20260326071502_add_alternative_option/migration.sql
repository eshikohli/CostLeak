...
CREATE TABLE "new_SavedRecommendation" (
    ...
    "alternativeOption" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_SavedRecommendation" ("analysisId", "createdAt", "estimatedAfterCost", "estimatedBeforeCost", "estimatedSavings", "estimationNote", "expectedImpact", "id", "issue", "recommendedFix", "saved") SELECT "analysisId", "createdAt", "estimatedAfterCost", "estimatedBeforeCost", "estimatedSavings", "estimationNote", "expectedImpact", "id", "issue", "recommendedFix", "saved" FROM "SavedRecommendation";
